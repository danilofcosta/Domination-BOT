...
type EditSheetProps = {
  ...
  fields: { name: string; label: string; defaultValue: string; placeholder?: string; type?: string }[];
  action: (formData: FormData) => Promise<ActionResult>;
};

export function EditSheet({ title, hiddenFields, fields, action }: EditSheetProps) {
